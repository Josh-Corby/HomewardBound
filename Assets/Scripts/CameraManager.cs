...
public class CameraManager : MonoBehaviour
{
    ...
    public float cameraFollowSpeed = 0.2f, cameraLookSpeed = 2, cameraPivotSpeed = 2, 
        cameraCollisionRadius = 0.2f, cameraCollisionOffSet = 0.2f, minimumCollisionOffSet = 0.2f;
